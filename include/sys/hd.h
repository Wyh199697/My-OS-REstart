...
{
	int			open_cnt;
	struct part_info	primary[NR_PRIM_PER_DRIVE]; //5
	struct part_info	logical[NR_SUB_PER_DRIVE]; //64
};
...
#define	PARTITION_TABLE_OFFSET	0x1BE   //引导扇区分区表偏移
