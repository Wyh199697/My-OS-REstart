...
#define	MAX_DRIVES		2	//硬盘数量
#define	NR_PART_PER_DRIVE	4	//分区数量
#define	NR_SUB_PER_PART		16	//每个扩展分区的逻辑分区数量
...
#define	MAX_SUBPARTITIONS	(NR_SUB_PER_DRIVE * MAX_DRIVES) //128

/* device numbers of hard disk */
#define	MINOR_hd1a		0x10 //16
#define	MINOR_hd2a		(MINOR_hd1a+NR_SUB_PER_PART) //32

#define	ROOT_DEV		MAKE_DEV(DEV_HD, MINOR_BOOT) //用于引导的逻辑分区,root_device,驱动程序号就是主设备号，驱动程序编号，次设备号就是hd2a
